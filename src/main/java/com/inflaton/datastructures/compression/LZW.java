...
import com.inflaton.datastructures.symboltable.trie.TST;
 ...
 *
 * <p>WARNING: Starting with Oracle Java 7u6, the substring method takes time and space linear in
 * the length of the extracted substring (instead of constant time an space as in earlier versions).
 * As a result, compression takes quadratic time. TODO: fix. See <a href =
