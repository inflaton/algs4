 ...
 * hashCode()}.
 *
 * <p>This implementation uses an (unbalanced) <em>binary search tree</em>. The <em>put</em>,
 * <em>contains</em>, <em>remove</em>, <em>minimum</em>, <em>maximum</em>, <em>ceiling</em>,
 * <em>floor</em>, <em>select</em>, and <em>rank</em> operations each take &Theta;(<em>n</em>) time
 * in the worst case, where <em>n</em> is the number of key-value pairs. The <em>size</em> and
 * <em>is-empty</em> operations take &Theta;(1) time. The keys method takes &Theta;(<em>n</em>) time
 * in the worst case. Construction takes &Theta;(1) time.
 *
 * <p>For alternative implementations of the symbol table API, see {@link ST}, {@link
 * BinarySearchST}, {@link SequentialSearchST}, {@link RedBlackBST}, {@link SeparateChainingHashST},
 * and {@link LinearProbingHashST}, For additional documentation, see <a
...
public class BST<Key extends Comparable<Key>, Value> {
  ...
  public static void main(String[] args) {
    ...
    for (TreeTraversalOrder order : orders) {
      ...
      StdOut.print("\t");
      for (String s : st.keys(order)) StdOut.print(s + "=>" + st.get(s) + " ");
      StdOut.println();
