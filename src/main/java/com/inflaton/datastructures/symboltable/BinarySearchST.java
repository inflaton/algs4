 ...
 * hashCode()}.
 *
 * <p>This implementation uses a <em>sorted array</em>. The <em>put</em> and <em>remove</em>
 * operations take &Theta;(<em>n</em>) time in the worst case. The <em>contains</em>,
 * <em>ceiling</em>, <em>floor</em>, and <em>rank</em> operations take &Theta;(log <em>n</em>) time
 * in the worst case. The <em>size</em>, <em>is-empty</em>, <em>minimum</em>, <em>maximum</em>, and
 * <em>select</em> operations take &Theta;(1) time. Construction takes &Theta;(1) time.
 *
 * <p>For alternative implementations of the symbol table API, see {@link ST}, {@link BST}, {@link
 * SequentialSearchST}, {@link RedBlackBST}, {@link SeparateChainingHashST}, and {@link
