 ...
 *
 * <p>This implementation uses <em>Dijkstra's algorithm</em> with a <em>binary heap</em>. The
 ...
 * &Theta;(1) time. It uses &Theta;(<em>V</em>) extra space (not including the edge-weighted
 * digraph).
 *
