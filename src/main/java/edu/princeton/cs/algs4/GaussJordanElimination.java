 ...
 *
 * <p>This computes correct results if all arithmetic performed is without floating-point rounding
 * error or arithmetic overflow. In practice, there will be floating-point rounding error; partial
 * pivoting helps prevent accumulated floating-point rounding errors from growing out of control
 * (though it does not provide any guarantees).
 *
