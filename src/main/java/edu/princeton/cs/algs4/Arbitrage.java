 ...
 *
 * <p>This code is guaranteed to find an arbitrage opportunity in a currency exchange table (or
 * report that no such arbitrage opportunity exists) under the assumption that all arithmetic
 * performed is without floating-point rounding error or arithmetic overflow. Since the code
 * computes the logarithms of the edge weights, floating-point rounding error will be present and it
 * may fail on some pathological inputs.
 *
