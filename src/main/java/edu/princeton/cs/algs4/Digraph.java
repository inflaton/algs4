 ...
 * the number of edges and <em>V</em> is the number of vertices. The <code>reverse()</code> method
 * takes &Theta;(<em>E</em> + <em>V</em>) time and space; all other instancce methods take
