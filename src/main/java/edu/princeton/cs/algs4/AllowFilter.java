...
/**
 * The {@code AllowFilter} class provides a client for reading in an <em>allowlist</em> of words
 * from a file; then, reading in a sequence of words from standard input, printing out each word
 * that appears in the file. It is useful as a test client for various symbol table implementations.
 *
