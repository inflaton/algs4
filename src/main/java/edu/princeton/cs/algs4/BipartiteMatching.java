 ...
 * network, but it does so with less overhead. The constructor takes <em>O</em>((<em>E</em> +
 * <em>V</em>) <em>V</em>) time, where <em>E</em> is the number of edges and <em>V</em> is the
 * number of vertices in the graph. It uses &Theta;(<em>V</em>) extra space (not including the
 * graph).
 *
 * <p>See also {@link HopcroftKarp}, which solves the problem in <em>O</em>(<em>E</em>
 ...
 * which solves the problem in <em>O</em>((<em>E</em> + <em>V</em>) <em>V</em>) time via a reduction
 * to maxflow.
 *
