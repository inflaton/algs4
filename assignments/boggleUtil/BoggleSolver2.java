...
public class BoggleSolver2 extends BoggleSolver {
  ...
  public static void run(String[] dictionary, BoggleBoard board, boolean useBoggleBoard2) {
    StdOut.println("useBoggleBoard2: " + useBoggleBoard2);
    Stopwatch stopwatch = new Stopwatch();
    BoggleSolver solver;
    if (useBoggleBoard2) {
      solver = new BoggleSolver2(dictionary);
    } else {
  ...
  public static void main(String[] args) {
    ...
    run(dictionary, board, true);
    run(dictionary, board, false);
  }
}
